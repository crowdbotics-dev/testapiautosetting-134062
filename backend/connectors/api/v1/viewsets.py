...
class Testconnectors134062ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS134062_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS134062_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS134062"
